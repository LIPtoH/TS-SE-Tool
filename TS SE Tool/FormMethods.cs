    ...
    public partial class FormMain
    {
        ...
        public void SetDefaultValues(bool _initial)
        {
            if (_initial)
            {
                ...
                SupportedSavefileVersionETS2 = new int[] { 61, 68 }; //Supported save version
                SupportedGameVersionETS2 = "1.43.x - 1.47.x"; //Last game version Tested on
        ...
        private void AddImagesToControls()
        {
            ...
            buttonProfilesAndSavesRestoreBackup.BackgroundImage = ProgUIImgsDict["Extract"];
