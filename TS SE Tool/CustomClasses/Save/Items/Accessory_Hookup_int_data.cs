...
{
    class Accessory_Hookup_int_data : SiiNBlockCore
    {
        #region variables
        ...
        */
        ...
        internal Accessory_Hookup_int_data()
        { }

        internal Accessory_Hookup_int_data(string[] _input)
        {
        ...
        internal string PrintOut(uint _version, string _nameless)
        {
            ...
            returnSB.AppendLine("accessory_hookup_int_data : " + _nameless + " {");
